...
> Osobní příběh sdílený se svolením. Průběh a výsledky léčby jsou u každé ženy jiné a tento text nenahrazuje lékařskou konzultaci.`,
  ...
  dailyCards: [
    ...
    },
    {
      ...
      phases: ['fertilization'],
      day: 0,
      headline: 'Zralých vajíček bývá méně než odebraných',
      body: 'Při odběru se odsávají folikuly, ale ne v každém je vajíčko a ne každé vajíčko je zralé. Embryolog pod mikroskopem posuzuje zralost, a jen zralá vajíčka mohou jít k oplození. Číslo, které jste slyšela na sále, se proto může do zítřka zmenšit. Není to chyba vaše ani kliniky, je to běžná cesta cyklu.',
      whatsHappening: [
        'Ne v každém odsátém folikulu se najde vajíčko.',
        'Nezralá vajíčka se běžně neoplozují, i když byla odebrána.',
        'U metody ICSI se zralost pozná dnes: embryolog vajíčko zbaví okolních buněk a pod mikroskopem na ni vidí.',
        'U klasického IVF se oplození hodnotí až druhý den ráno, tedy den po odběru.',
      ],
      reflection: 'Co si dnes o číslech říkám, i když je ještě neznám?',
      tip: 'Zapisujte si obě čísla zvlášť: kolik vajíček bylo odebráno a kolik jich bylo zralých. Ta dvě čísla se běžně liší a je snadné si je potom poplést.',
    },
    {
      id: 'fert-dc2-2',
      phases: ['fertilization'],
      day: 0,
      headline: 'Na dnešek už nemáte vliv',
      body: 'Vajíčka a spermie jsou v inkubátoru a další krok probíhá bez vás. Nic, co dnes sníte, uděláte nebo neuděláte, tenhle proces neovlivní. Bezmoc, kterou cítíte, není slabost, je to přesný popis situace. Nemusíte ji přebíjet optimismem.',
      whatsHappening: [
        'Vajíčka a spermie jsou v inkubátoru s řízenou teplotou a složením plynů.',
        'Laboratoř je dnes většinou nechává v klidu, aby oplození mohlo proběhnout.',
        'Tělo se zotavuje po odběru, bývá tlak v podbřišku, nadýmání a únava.',
        'Podpůrné léky berte přesně podle rozpisu kliniky, sama je nevysazujte.',
      ],
      task: 'Naplánujte si na dnešní večer jednu konkrétní věc na hodinu, která po vás nechce žádné rozhodování. Seriál, vana, procházka s někým, kdo se nebude vyptávat.',
      callDoctorIf: [
        'Bolest břicha, která se stupňuje a neustupuje po lécích doporučených klinikou.',
        'Teplota nad 38 stupňů.',
        'Silnější krvácení z pochvy, výrazně větší než slabé špinění.',
        'Rychle rostoucí objem břicha, prudký přírůstek hmotnosti nebo málo moči.',
        'Dušnost, opakované zvracení nebo točení hlavy až mdloby.',
      ],
    },
    {
      id: 'fert-dc2-3',
      phases: ['fertilization'],
      day: 1,
      headline: 'Než zazvoní telefon z embryologie',
      body: 'Dnes vám má volat embryolog s prvním číslem. Hovor bývá krátký, často jen pár minut, a hodně žen si z něj potom pamatuje sotva polovinu. Než telefon zazvoní, připravte si tužku a otázky, na které se chcete zeptat.',
      whatsHappening: [
        'Klinika obvykle volá dopoledne, přesný čas se ale liší podle provozu laboratoře.',
        'Číslo, které uslyšíte, je počet oplozených vajíček se dvěma prvojádry.',
        'Embryolog popisuje, co vidí. Co to znamená pro váš další plán, řeší lékař.',
        'Další zpráva většinou přichází až po několika dnech kultivace, ne dnes odpoledne.',
      ],
      task: 'Napište si do poznámek v aplikaci BlooMia tři otázky: kolik vajíček bylo zralých, kolik se jich oplodnilo a kdy vám klinika zavolá příště.',
      reflection: 'Koho dnes chci mít u sebe, až telefon zazvoní?',
      tip: 'Mějte telefon nabitý a nahlas. Čísla si zapište doslova, včetně jména toho, kdo volal, ať se máte příště na koho odvolat.',
    },
    {
      id: 'fert-dc2-4',
      phases: ['fertilization'],
      day: 1,
      headline: 'Když je číslo nižší, než jste čekala',
      body: 'Čísla se cestou zmenšují a samo o sobě to neznamená, že jste něco pokazila. Z počtu oplozených vajíček se nedá předpovědět, jak cyklus dopadne, a nikdo vám dnes nemůže dát jistotu. Pokud jste čekala víc, máte právo být zklamaná i naštvaná. Nemusíte to hned obracet v naději.',
      whatsHappening: [
        'Část zralých vajíček se neoplodní, u klasického IVF i u metody ICSI.',
        'Někdy se objeví vajíčka s jiným počtem prvojader, ta se dál obvykle nepoužívají.',
        'Kvalitu vajíček a spermií jste tenhle týden neovlivnila tím, co jste jedla nebo dělala.',
        'Jak bude vypadat kultivace, transfer nebo zamražení, určuje klinika podle dalšího vývoje.',
      ],
      reflection: 'Co bych dnes řekla kamarádce, která má stejné číslo jako já?',
      tip: 'Zkuste dnes nehledat na internetu, kolik oplozených vajíček „stačí“. Najdete cizí příběhy, ne odpověď na svůj.',
      callDoctorIf: [
        'Nikdo vám nezavolal do konce ordinační doby a výsledek neznáte.',
        'Číslům jste nerozuměla a nevíte, kolik vajíček se dál kultivuje.',
        'Nevíte, kdy a jestli máte přijít na další kontrolu nebo transfer.',
        'Nejste si jistá, které léky teď máte brát a v jakých časech.',
        'Cítíte se tak špatně, že nezvládáte běžný den, nebo se objevují myšlenky na sebepoškození. Ozvěte se klinice nebo vyhledejte odbornou pomoc.',
      ],
    },
    {
      id: 'punk-dc2-1',
      phases: ['retrieval'],
      day: 0,
      headline: 'Narkóza odchází pomaleji, než si myslíte',
      body: 'Probudila jste se rychle, ale léky z narkózy odcházejí z těla ještě několik hodin. Proto dnes neřídíte auto, nepodepisujete nic důležitého a pokud to jde, nezůstáváte doma sama. Ospalost, zimnice nebo sucho v krku po zákroku jsou běžné. Dnešek patří posteli a někomu, kdo vám donese čaj.',
      whatsHappening: [
        'Analgosedace odeznívá postupně, i když jste vzhůru a mluvíte',
        'Řídit auto dnes nemůžete, ani když se cítíte svěže',
        'Slabé špinění po vpichu přes poševní stěnu bývá krátké',
        'Tah v podbřišku může zesílit, jakmile odezní léky proti bolesti',
      ],
      task: 'Připravte si k posteli vodu, telefon a číslo na kliniku, ať to nemusíte večer hledat.',
      reflection: 'Co dnes zvládnu odložit na zítra?',
      tip: 'Než vstanete, posaďte se nejdřív na okraj postele a chvíli počkejte. Po narkóze se hlava zatočí snadno.',
      callDoctorIf: [
        'Silné krvácení, které během hodiny prosákne vložku',
        'Horečka nad 38 stupňů',
        'Bolest břicha, na kterou nezabírá běžný lék proti bolesti',
        'Opakované zvracení, kdy v sobě neudržíte ani vodu',
        'Mdloba nebo točení hlavy, kvůli kterému se nepostavíte',
      ],
    },
    {
      id: 'punk-dc2-2',
      phases: ['retrieval'],
      dayRange: [0, 5],
      headline: 'Pijte po douškách, bílkoviny ke každému jídlu',
      body: 'Po stimulaci jsou vaječníky zvětšené a tělo hospodaří s tekutinami jinak než obvykle. Dostatek pití a bílkovin patří k tomu, co kliniky po odběru doporučují nejčastěji, konkrétní množství si potvrďte u své sestry. Nemusíte do sebe lít velké sklenice, stačí pít průběžně po douškách. Když se vám nechce jíst, zkuste jogurt, tvaroh, vývar nebo vajíčko.',
      whatsHappening: [
        'Nafouklé břicho po odběru nejsou jen plyny, souvisí i s tekutinami',
        'Zácpa po narkóze a lécích proti bolesti bývá častá',
        'Chuť k jídlu se první den nemusí vrátit vůbec',
        'Teplý slaný vývar se do vás vejde snáz než litr čisté vody',
      ],
      task: 'Postavte si vedle sebe láhev s vodou a připravte jednu bílkovinovou svačinu na odpoledne.',
      reflection: 'Co dnes dokážu sníst, i když nemám hlad?',
      tip: 'Vážit se ráno má smysl. Ne kvůli číslu, ale proto, aby vám neušel rychlý nárůst. Zápis si můžete vést v aplikaci BlooMia.',
    },
    {
      id: 'punk-dc2-3',
      phases: ['retrieval'],
      day: 1,
      headline: 'Kdy je nafouklé břicho už varovný signál',
      body: 'Tah v podbřišku, nafouklé břicho a únava po odběru se týkají velké části žen a během pár dní obvykle ustupují. U ovariálního hyperstimulačního syndromu je to jiné: potíže se den ode dne zhoršují a přidává se dušnost, rychlé přibývání na váze a málo moči. Rozhodovat o tom nemusíte sama, od toho je telefon na kliniku. Falešný poplach tam nikoho neurazí, jsou na to zvyklí.',
      whatsHappening: [
        'Běžné potíže po odběru se každý den spíš mírně zlepšují',
        'Obvod břicha, který roste po hodinách, je jiný signál než nafouknutí po jídle',
        'Kilogram za den není zadržená večeře',
        'Časnější podoba nastupuje zhruba třetí až sedmý den po odběru, pozdější zhruba od konce prvního týdne, hlavně když došlo k transferu.',
        'Varovné příznaky platí stejně v obou obdobích, rozhoduje jejich rychlost a síla, ne den v kalendáři.',
      ],
      task: 'Změřte si krejčovským metrem obvod břicha a číslo si zapište. Zítra ho porovnáte.',
      tip: 'Všímejte si, kolikrát za den jdete na malou. Výrazný pokles patří do telefonu na kliniku, ne do čekání do rána.',
      callDoctorIf: [
        'Rychle rostoucí obvod břicha nebo přírůstek přes kilogram za den',
        'Dušnost, tlak na hrudi nebo nemožnost se vleže nadechnout',
        'Výrazně méně moči než obvykle nebo tmavá moč přes den',
        'Bolest břicha, která se stupňuje a nepolevuje',
        'Zvracení, kvůli kterému v sobě neudržíte tekutiny',
      ],
    },
    {
      id: 'punk-dc2-4',
      phases: ['retrieval'],
      day: 2,
      headline: 'Návrat do práce a co říct okolí',
      body: 'Kdy se vrátit do práce, záleží na tom, jak se cítíte a co jste domluvila s lékařem. Někomu stačí den, jiná žena potřebuje celý týden a obojí je v pořádku. Okolí nedlužíte vysvětlení. „Byla jsem na malém zákroku“ je celá věta, za kterou nemusí nic následovat.',
      whatsHappening: [
        'Nafouklé břicho je pár dní vidět, volnější kalhoty pomůžou víc než výmluvy',
        'Sedět celý den v kanceláři bývá po odběru nepohodlnější než chodit',
        'Zvedání těžkého a intenzivní sport se zatím obvykle nedoporučují, termín si potvrďte na klinice',
        'Soustředění bývá roztříštěné, na složité úkoly to teď nemusí být',
      ],
      task: 'Napište si předem jednu větu, kterou odpovíte, když se vás někdo v práci zeptá, co vám bylo.',
      reflection: 'Komu v práci chci něco říct a komu vlastně vůbec ne?',
      tip: 'Pokud máte neschopenku, zaměstnavatel z ní diagnózu nevyčte. Nemusíte k ní nic doplňovat.',
    },
    {
      id: 'prep-dc2-1',
      phases: ['ivf_prep'],
      dayRange: [0, 7],
      headline: 'Nácvik injekce, než dojde na ostro',
      body: 'První aplikaci si můžete projít nanečisto dřív, než na ni doopravdy dojde. Většina klinik postup ukazuje osobně nebo posílá video, poproste klidně o obojí. Nacvičte si celou sekvenci naprázdno: umýt ruce, připravit pero, zkontrolovat název a datum, vydezinfikovat místo, počkat po vpichu. Ruce si pohyb zapamatují dřív než hlava.',
      whatsHappening: [
        'Podkožní injekce se u většiny protokolů aplikují do podkoží břicha, mimo okolí pupku',
        'Kůži nadzvednete do řasy, úhel a hloubka se liší podle typu pera',
        'Po stisknutí se ještě chvíli počítá, než pero vytáhnete, přesný počet vteřin řekne klinika',
        'Místa vpichu se střídají, aby se kůže nedráždila pořád na stejném místě',
      ],
      task: 'Vezměte prázdné pero nebo jen dezinfekční tampon a projděte si celý postup nahlas, krok za krokem.',
      reflection: 'Co mi na aplikaci vadí víc: jehla, nebo to, že to musím udělat sama?',
      tip: 'Pokud vám vadí pohled na jehlu, domluvte si někoho na první dva tři dny. Není to slabost, je to nácvik.',
      callDoctorIf: [
        'Instruktáž jste viděla jen jednou a nejste si postupem jistá',
        'Pero nebo stříkačka vypadají poškozeně, roztok je zakalený',
        'Chybí vám část pomůcek: jehly, tampony, nádoba na ostrý odpad',
        'Nemáte doma nikoho na pomoc a bojíte se, že aplikaci nezvládnete',
      ],
    },
    {
      id: 'prep-dc2-2',
      phases: ['ivf_prep'],
      dayRange: [0, 8],
      headline: 'Léky objednejte dřív, než je budete potřebovat',
      body: 'Část léků na stimulaci nemá lékárna běžně skladem a objednává je s několikadenním předstihem. Zavolejte tam s protokolem v ruce a zeptejte se, co mají a co se musí dovézt. Vyzvedněte si je s rezervou, ne den před startem.',
      whatsHappening: [
        'Recepty bývají elektronické, do lékárny stačí identifikátor nebo kartička',
        'Některé přípravky se vozí jen v určité dny, o víkendu obvykle dovoz není',
        'Část léků patří do chladničky, převoz domů řešte v chladicí tašce',
        'Doplatky se mezi lékárnami liší, dají se ověřit telefonem předem',
      ],
      task: 'Zavolejte do lékárny a projděte s nimi položku po položce: dostupnost, termín a doplatek.',
      tip: 'Název léku v protokolu a název na krabičce se nemusí shodovat. Když se liší, ověřte si to na klinice nebo v lékárně, ne na diskusním fóru.',
      callDoctorIf: [
        'Lékárna lék nemá a nedokáže říct termín dodání',
        'Na krabičce je jiný název nebo jiná síla, než máte v protokolu',
        'Lék, který patří do chladničky, strávil cestu nebo noc v teple',
        'Recept propadl nebo na něm chybí část předepsaných léků',
      ],
    },
    {
      id: 'prep-dc2-3',
      phases: ['ivf_prep'],
      dayRange: [0, 10],
      headline: 'Zkratky v protokolu přeložené do češtiny',
      body: 'Protokol je psaný zkratkami, které nikdo nevysvětluje, protože jsou pro personál samozřejmé. Nemusíte je umět nazpaměť, ale pomůže vám vědět, co znamenají, až ve dveřích uslyšíte tři písmena a číslo. Když si nejste jistá, zeptejte se. I podruhé.',
      whatsHappening: [
        'FSH a LH jsou hormony, které řídí zrání folikulů',
        'AMH bývá součástí vstupních vyšetření a vypovídá o vaječníkové rezervě',
        'OPU je odběr vajíček, ET je transfer embrya',
        'hCG se v protokolu objevuje dvakrát: jako spouštěcí injekce a později jako těhotenský test z krve',
      ],
      task: 'Projděte protokol a podtrhněte každou zkratku, které nerozumíte. Seznam vezměte na nejbližší kontrolu.',
      reflection: 'Které slovo v protokolu ve mně dělá největší nejistotu?',
      tip: 'Svoje hodnoty si nevykládejte podle internetu. Čísla dávají smysl jen v souvislostech, které zná váš lékař.',
    },
    {
      id: 'prep-dc2-4',
      phases: ['ivf_prep'],
      dayRange: [1, 12],
      headline: 'Přepište si protokol tak, abyste v něm četla',
      body: 'Papír z kliniky je psaný pro kliniku, ne pro vás v šest ráno. Přepište si ho do jednoduché tabulky: datum, lék, dávka, čas, odškrtnuto. Originál si nechte, přepis je jen denní vodítko, ne náhrada. Dávky si podle něj nikdy neupravujte sama, o změnách rozhoduje lékař.',
      whatsHappening: [
        'Jeden řádek na den se čte lépe než souvislý odstavec',
        'Čas aplikace bývá každý den stejný, zapište ho číslem, ne slovem večer',
        'Sloupec na odškrtnutí ukáže, jestli dávka opravdu proběhla',
        'Změny z kontrol se dopisují, staré řádky škrtněte, nemažte',
      ],
      task: 'Nakreslete si tabulku na papír nebo si ji založte v aplikaci BlooMia a vyplňte první týden.',
      tip: 'Vyfoťte si originální protokol do telefonu. Papír se ztrácí, telefon máte u sebe pořád.',
      callDoctorIf: [
        'Dvě informace v protokolu si navzájem odporují',
        'Nevíte jistě, kolik jednotek a v kolik hodin máte aplikovat',
        'Vynechala jste dávku nebo si nejste jistá, jestli proběhla celá',
        'Nové pokyny z kontroly nesouhlasí s tím, co máte na papíře',
      ],
    },
    {
      id: 'prep-dc2-5',
      phases: ['ivf_prep'],
      dayRange: [1, 15],
      headline: 'Otázky, které se vyplatí položit před startem',
      body: 'Na kontrolách je málo času a otázky člověka napadají až v autě cestou domů. Napište si je předem a vezměte seznam s sebou, klidně v telefonu. Číst z papíru není ostuda, je to jediný způsob, jak na nic nezapomenout.',
      whatsHappening: [
        'Kdo bere telefon, když se něco stane večer, o víkendu nebo o svátku',
        'Jak rychle chodí výsledky ranních odběrů a kdo vám volá se změnou dávky',
        'Kolik kontrol se dá čekat a jak dlouho dopředu se termíny hlásí',
        'Co se děje, když se cyklus zruší, a jak se řeší další postup',
      ],
      task: 'Zapište si tři otázky, které vás napadly za poslední týden, a přidejte je k seznamu.',
      reflection: 'Na co se bojím zeptat, protože se bojím odpovědi?',
      tip: 'Odpovědi si zapisujte hned na místě. Za dvě hodiny budete přesvědčená, že jste slyšela něco jiného.',
    },
    {
      id: 'prep-dc2-6',
      phases: ['ivf_prep'],
      dayRange: [3, 17],
      headline: 'Rozpočet, který nepřekvapí uprostřed cyklu',
      body: 'Část výkonů hradí pojišťovna, část si platíte a doplatky za léky se sčítají rychleji, než čekáte. Vyžádejte si na klinice ceník a zeptejte se konkrétně, co se platí navíc a v kterém okamžiku. Vědět dopředu, kolik to bude stát, je praktická věc, ne nedostatek naděje.',
      whatsHappening: [
        'Léky platíte v lékárně, výkony na klinice, jsou to dvě oddělené částky',
        'Metody navíc, například prodloužená kultivace nebo zamrazení embryí, se doplácejí zvlášť',
        'Skladování zamrazených embryí se platí opakovaně, obvykle jednou za rok',
        'Doklady si schovávejte, někteří zaměstnavatelé nebo pojišťovny přispívají zpětně',
      ],
      task: 'Založte si obálku nebo složku v telefonu jen na účtenky z kliniky a z lékárny.',
      tip: 'Domluvte se doma, z jakých peněz se to platí, ještě než přijde první větší účet. Ušetří to hádku ve špatný den.',
    },
    {
      id: 'prep-dc2-7',
      phases: ['ivf_prep'],
      dayRange: [5, 19],
      headline: 'Doprava na ranní kontroly bez stresu',
      body: 'Kontroly bývají brzy ráno a termín se často upřesňuje až den předem. Projděte si trasu, parkování i náhradní variantu pro případ, že auto nepojede. Půl hodiny rezervy je lepší než jízda v křeči.',
      whatsHappening: [
        'Kontroly bývají brzy ráno. Jestli je potřeba přijít nalačno, se liší podle toho, co se odebírá, ověřte si to na klinice, fronta bývá hned po otevření největší',
        'Parkování u kliniky bývá placené a plné, hodí se drobné nebo aplikace na parkovné',
        'Termín se často hlásí večer předem, počítejte s tím při plánování směn',
        'Cesta zpátky může trvat déle, po ultrazvuku se občas ještě čeká',
      ],
      task: 'Ověřte si spojení nebo parkování na první kontrolu a uložte si trasu do telefonu.',
      tip: 'Pokud vás někdo může vozit, řekněte si o to teď, ne až ráno v šest. Lidé řeknou ano častěji, když mají čas se zařídit.',
    },
    {
      id: 'prep-dc2-8',
      phases: ['ivf_prep'],
      dayRange: [7, 21],
      headline: 'Taška na kontrolu sbalená dopředu',
      body: 'Na kliniku pojedete znovu a znovu a balit se pokaždé od nuly je zbytečná zátěž. Připravte si jednu malou tašku, kterou jen vezmete ze skříňky u dveří. Zůstane v ní všechno, co se opakuje.',
      whatsHappening: [
        'Kartička pojišťovny, občanský průkaz a papíry z kliniky patří na jedno místo',
        'Ponožky navíc se hodí, na vyšetřovacím křesle bývá zima',
        'Po odběru nalačno oceníte jídlo a pití hned v tašce, ne až doma',
        'Nabíječka nebo powerbanka, čekání se protahuje a telefon je jediná zábava',
      ],
      task: 'Sbalte tašku dnes večer a nechte ji u dveří nebo rovnou v autě.',
      tip: 'Přidejte tužku. Poznámky psané do telefonu ve frontě se ztrácejí, papír vydrží.',
    },
    {
      id: 'prep-dc2-9',
      phases: ['ivf_prep'],
      dayRange: [9, 23],
      headline: 'Komu v práci to říct a komu ne',
      body: 'V práci nemusíte říkat nic, léčba je vaše soukromá věc. Zároveň se hodí mít jednoho člověka, který ví aspoň to, že budete občas ráno chybět. Vybírejte podle toho, kdo umí mlčet, ne podle funkce.',
      whatsHappening: [
        'Hlavní dopad na práci jsou ranní kontroly hlášené krátce dopředu',
        'Nadřízenému stačí věta o opakovaném vyšetření, diagnózu sdělovat nemusíte',
        'Kolegovi, který kryje vaši práci, pomůžou termíny, ne důvody',
        'Odběr vajíček obvykle znamená jeden den, kdy nebudete k dispozici, a plánuje se na poslední chvíli',
      ],
      task: 'Napište si jednu větu, kterou použijete, až se vás někdo zeptá, kam ráno chodíte.',
      reflection: 'Komu chci říct pravdu, a komu ji říkám jen proto, že se zeptal?',
      tip: 'Předpřipravená věta funguje líp než improvizace u kávovaru. Stačí jedna, klidně pořád stejná.',
    },
    {
      id: 'prep-dc2-10',
      phases: ['ivf_prep'],
      dayRange: [11, 26],
      headline: 'Proč čísla po cestě klesají',
      body: 'Folikulů bývá víc než odebraných vajíček, oplozených vajíček méně než odebraných a do transferu jich dojde ještě méně. Není to vaše selhání ani chyba kliniky, takhle ten proces vypadá u velké části cyklů. Vědět to dopředu bolí míň než se to dozvědět v den, kdy zazvoní telefon s nižším číslem. Jeden cyklus není záruka a není nutné to ustát s úsměvem.',
      whatsHappening: [
        'Na ultrazvuku se počítají folikuly, ne vajíčka, a ne v každém folikulu vajíčko je',
        'Část odebraných vajíček nemusí být zralá k oplození',
        'Ne každé oplozené vajíčko se dělí dál do dalších dnů kultivace',
        'Klinika hlásí čísla postupně, obvykle telefonem, v několika dnech po sobě',
      ],
      reflection: 'Co si potřebuju říct, až mi zavolají číslo nižší, než jsem čekala?',
      tip: 'Domluvte se dopředu, kdo telefony z laboratoře bere a komu je předá dál. Ve chvíli, kdy zazvoní, se domlouvá špatně.',
    },
    {
      id: 'prep-dc2-11',
      phases: ['ivf_prep'],
      dayRange: [12, 30],
      headline: 'Poslední kontrola, co ještě chybí',
      body: 'Před startem musí být vstupní vyšetření kompletní, vaše i partnerova. Některé výsledky mají omezenou platnost a stihnou propadnout dřív, než se dostanete ke stimulaci. Projděte si seznam z kliniky položku po položce a co chybí, doobjednejte teď.',
      whatsHappening: [
        'Sérologie a část výtěrů mají omezenou platnost, počítá se na měsíce',
        'Spermiogram partnera bývá potřeba čerstvý, objednací lhůty se liší',
        'Některá vyšetření dělá váš gynekolog nebo praktik, ne klinika',
        'Jeden chybějící papír dokáže odsunout start o celý cyklus',
      ],
      task: 'Porovnejte seznam vyšetření z kliniky se svými výsledky a zakroužkujte, co chybí.',
      callDoctorIf: [
        'Nevíte, jestli je některý výsledek ještě platný',
        'Máte horečku, zánět nebo užíváte antibiotika',
        'Menstruace nepřišla v době, kdy se podle plánu čekala',
        'Začala jste užívat nový lék předepsaný jiným lékařem',
        'Čekáte na výsledek, který nedorazil, a termín startu se blíží',
      ],
    },
    {
      id: 'prep-dc2-12',
      phases: ['ivf_prep'],
      dayRange: [14, 36],
      headline: 'Poslední víkend, než to začne',
      body: 'Za pár dní se váš kalendář začne řídit klinikou. Tenhle víkend ještě patří vám, nemusí být výjimečný, stačí, když bude váš. Udělejte jednu věc, na kterou v dalších týdnech nebude prostor, a jednu praktickou, která vám zjednoduší život.',
      whatsHappening: [
        'Po startu stimulace se plánuje ze dne na den, delší cesty jsou složitější',
        'Zásoby jídla a vyprané prádlo dopředu ušetří večery, kdy nebudete mít sílu',
        'Náročný sport a sauna se během stimulace obvykle omezují, zeptejte se na klinice',
        'Spánek se dopředu nashromáždit nedá, ale klidný víkend rozdíl dělá',
      ],
      task: 'Naplánujte na víkend jednu věc, která nemá s léčbou nic společného.',
      reflection: 'Co si z téhle přípravné fáze budu chtít pamatovat, až skončí?',
      tip: 'Nemusíte se cítit připravená ani odhodlaná. Stačí, že víte, co máte udělat první den.',
    },
  ],
  encouragements: [
    {
