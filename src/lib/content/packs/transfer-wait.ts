...
Zapište si těch pět otázek na papír a dejte ho k telefonu.`,
  ...
  dailyCards: [
    ...
    {
      id: 'tww-dc-2ww-den-15',
      phases: ['two_week_wait'],
      day: 15,
      headline: 'Když výsledek ještě není',
      body: 'Termín odběru se mezi klinikami liší podle dne embrya a typu transferu, takže patnáctý den bez výsledku nic neznamená. Znamená jen to, že váš plán vypadá jinak než tabulka na internetu. Pokud jste odběr ještě neměla, domluvte si ho. Domácí test tenhle krok nenahradí a další den čekání ho nezpřesní.',
      whatsHappening: [
        'Laboratoře posílají výsledky v různých časech, některé kliniky volají až odpoledne',
        'Podpora luteální fáze pokračuje beze změny, dokud lékař neřekne jinak',
        'Domácí test v tomhle období může být falešně negativní i falešně pozitivní',
      ],
      task: 'Zapište si do aplikace, kdy odběr máte nebo kdy jste ho absolvovala. Dnešek se pak přizpůsobí tomu, kde doopravdy jste.',
      reflection: 'Co bych dnes potřebovala slyšet od někoho, komu věřím?',
      tip: 'Když se s vámi klinika do domluvené hodiny nespojí, zavolejte vy.',
    },
    {
      id: 'tww-dc-2ww-den-16',
      phases: ['two_week_wait'],
      day: 16,
      headline: 'Jedno číslo není celý příběh',
      body: 'Pokud výsledek máte, skoro jistě k němu bude patřit druhý odběr za dva až tři dny. Sleduje se totiž vývoj v čase, ne jedna hodnota. Právě proto se z prvního čísla nedá číst konečný verdikt ani v dobrém, ani ve zlém, a proto nemá smysl hledat cizí hodnoty na internetu.',
      whatsHappening: [
        'Mezi odběry se nedá udělat nic, co by číslo ovlivnilo',
        'Hodnoty z různých laboratoří nemusí být plně srovnatelné',
        'Zdvojení zhruba za 48 až 72 hodin je orientační pravidlo, ne zákon',
      ],
      reflection: 'Komu dovolím, aby mi teď pomohl to unést?',
      tip: 'Zapište si přesnou hodnotu i datum odběru. U druhého odběru se budete ptát právě na rozdíl mezi nimi.',
    },
    {
      id: 'tww-dc-2ww-den-17',
      phases: ['two_week_wait'],
      day: 17,
      headline: 'Špinění a křeče v tomhle období',
      body: 'Lehké špinění i tahavé bolesti se objevují často a samy o sobě nic neznamenají. Souvisejí s hormonální podporou i se změnami v děloze. Platí to v obou směrech: ani jejich přítomnost, ani jejich nepřítomnost nic nedokazuje.',
      whatsHappening: [
        'Vaginální podpora může sama způsobit podráždění a špinění',
        'Progesteron zpomaluje trávení, takže nadýmání a zácpa jsou běžné',
        'Prsa mohou být citlivá z podpory úplně stejně jako z těhotenství',
      ],
      tip: 'Podporu nikdy nevysazujte sama, ani při krvácení. O ukončení rozhoduje lékař podle hodnoty hCG.',
      callDoctorIf: [
        'Silné krvácení nebo krvácení se sraženinami',
        'Prudká, zejména jednostranná bolest v podbřišku',
        'Bolest v rameni, mdloba, závrať nebo studený pot',
    ...
    {
      id: 'tww-dc-2ww-den-18',
      phases: ['two_week_wait'],
      dayRange: [18, 21],
      headline: 'Mezi laboratoří a ultrazvukem',
      body: 'Od téhle chvíle přestávají odběry přinášet novou informaci a další krok patří ultrazvuku. Bývá to období, kdy úzkost roste, protože ubyla čísla a obraz ještě nepřibyl. Je to normální reakce na prázdné místo, ne signál o výsledku.',
      whatsHappening: [
        'Plodové vejce bývá na vaginálním ultrazvuku vidět zhruba mezi pátým a šestým týdnem těhotenství',
        'Termín vyšetření určuje klinika podle vašich hodnot, ne podle kalendáře',
        'Dřívější ultrazvuk často jen přidá nejistotu, protože ještě není co vidět',
      ],
      task: 'Připravte si k vyšetření data odběrů a jejich hodnoty, datum transferu, den embrya a názvy léků. V aplikaci to máte, stačí otevřít přehled.',
      reflection: 'Co si chci na ultrazvuk vzít s sebou, kromě dokladů?',
      tip: 'Na vyšetření se dá vzít doprovod. Většina klinik to umožní, i když se to nikde nepíše.',
    },
    {
      id: 'tww-dc-2ww-den-22',
      phases: ['two_week_wait'],
      dayRange: [22, 45],
      headline: 'Tahle část už není o dnech po transferu',
      body: 'Další kroky určuje váš výsledek a vaše klinika, ne počítání dní. Pokud se něco změnilo, ať už jakkoliv, zapište to prosím do aplikace. Dokud tam výsledek není, BlooMia počítá dál a nemá jak vědět, že jste se posunula jinam.',
      whatsHappening: [
        'Cyklus se v aplikaci uzavírá jedním z devíti výsledků, včetně těch těžkých',
        'Po zápisu se obsah přizpůsobí tomu, kde jste, a přestane mluvit o čekání',
      ],
      task: 'Otevřete kartu cyklu a doplňte výsledek transferu. Zabere to půl minuty.',
      reflection: 'Co bych si z tohohle období chtěla zapamatovat, i kdyby to dopadlo jinak, než jsem doufala?',
    },
    {
      id: 'tww-dc-2ww-ket',
      phases: ['two_week_wait'],
    ...
    },
    {
      ...
      phases: ['transfer'],
      day: 0,
      headline: 'Zákrok trvá pár minut',
      body: 'Tenkým katétrem se embryo přenese přes děložní hrdlo do dutiny děložní, obvykle pod kontrolou ultrazvuku a bez narkózy. Plný močový měchýř je jen kvůli lepšímu obrazu, po zákroku můžete na toaletu. Děloha není trubka: její stěny na sebe doléhají a embryo z ní nevypadne, ani když vstanete a půjdete domů. Ležení po transferu podle dnešních poznatků výsledek nezlepšuje, takže se můžete hýbat běžným tempem.',
      whatsHappening: [
        'Katétr se zavádí přes hrdlo, většina žen cítí nanejvýš tlak jako při stěru',
        'Plný měchýř narovnává úhel dělohy a zlepšuje obraz na ultrazvuku',
        'Embryolog po přenosu kontroluje katétr, jestli v něm embryo nezůstalo',
        'Slabé křeče nebo kapka růžového hlenu po zákroku bývají od dotyku hrdla, ne od embrya',
      ],
      task: 'Připravte si na cestu domů lahev vody a něco k jídlu. Po dopoledni na klinice budete mít nejspíš žízeň a hlad.',
      tip: 'Dnešek nemusí být den vleže. Klidná chůze, teplá sprcha a lehké jídlo jsou v pořádku. Vynechte jen to, co by vám sama klinika zakázala, typicky saunu, plavání a intenzivní sport.',
      callDoctorIf: [
        'Máte silné krvácení, které nasytí vložku',
        'Máte horečku nad 38 stupňů',
        'Bolest břicha je silná, narůstá nebo vystřeluje do ramene',
        'Nemůžete se vymočit několik hodin po zákroku',
        'Rychle přibýváte na váze, břicho se napíná nebo se hůř dýchá',
      ],
    },
    {
      id: 'tr-dc2-2',
      phases: ['transfer'],
      day: 0,
      headline: 'Čerstvý transfer nebo kryotransfer',
      body: 'Při čerstvém transferu jde embryo do dělohy pár dní po odběru vajíček, tělo je tedy ještě po stimulaci. Při kryotransferu se embryo rozmrazuje v den přenosu a cyklus je buď přirozený, nebo připravovaný léky. Obě cesty se běžně používají a o té vaší rozhoduje klinika podle vaší situace, ne podle toho, co je obecně lepší. Pokud nevíte, proč jste dostala zrovna tuhle variantu, je úplně v pořádku se na to zeptat.',
      whatsHappening: [
        'U čerstvého transferu bývají vaječníky po stimulaci ještě zvětšené a citlivé',
        'U kryotransferu se sleduje, jestli embryo přežilo rozmrazení, embryolog vám to obvykle řekne',
        'Podpora luteální fáze se u obou variant liší v dávkách i délce',
        'Někdy se čerstvý transfer odkládá kvůli riziku hyperstimulace nebo kvůli stavu sliznice',
      ],
      reflection: 'Vím, proč mi klinika doporučila právě tuhle variantu, a sedí mi to vysvětlení?',
      tip: 'Zapište si do aplikace BlooMia, o jaký typ transferu šlo. Vlastní záznam se hodí při každém dalším rozhodování s lékařem.',
    },
    {
      id: 'tr-dc2-3',
      phases: ['transfer'],
      day: 0,
      headline: 'Než odejdete z kliniky',
      body: 'Dnes vám řeknou spoustu informací a vy si z nich pod tlakem zapamatujete zlomek. Vyplatí se mít připravené otázky a odpovědi si rovnou zapsat nebo nahrát do telefonu. Nikdo vás nebude mít za otravnou, tohle je běžná součást dne.',
      whatsHappening: [
        'Den embrya v době přenosu, tedy jestli šlo o třetí, pátý nebo šestý den vývoje',
        'Popis embrya podle hodnocení dané laboratoře a kolik embryí bylo přeneseno',
        'Kolik embryí zbylo ke zmrazení, pokud nějaká zbyla',
        'Jaká podpora, v jaké dávce a do kdy, a přesné datum odběru hCG',
      ],
      task: 'Otevřete si poznámky v telefonu a zapište čtyři věci: den embrya, jeho popis, název a dávkování podpory, datum odběru. Zabere to dvě minuty a ušetří vám to týden dohadování.',
      tip: 'Zeptejte se také na telefonní číslo, kam volat mimo ordinační hodiny, a co přesně mají za důvod k okamžitému kontaktu.',
      callDoctorIf: [
        'Nejste si jistá, kdy a čím máte pokračovat v podpoře',
        'Vypadla vám dávka léku nebo jste si nebyla jistá aplikací',
        'Zapomněla jste, kdy máte přijít na odběr, a nemáte to nikde napsané',
        'Po zákroku vás bolí břicho víc, než jak vám na klinice popsali jako obvyklé',
        'Objeví se krvácení silnější než slabé špinění',
      ],
    },
    {
      id: 'tr-dc2-4',
      phases: ['transfer'],
      day: 0,
      headline: 'Euforie a strach v jednom dni',
      body: 'Aktivní část skončila, teď se nedá dělat nic, co by výsledek posunulo. Právě ta bezmoc je na dnešku často nejtěžší, protože se v jedné hodině střídá dojetí a čirá hrůza. Nemusíte myslet pozitivně a nemusíte dnešek prožít slavnostně. Cokoli dnes cítíte, včetně otupělosti nebo pláče cestou z kliniky, je normální reakce na měsíce napětí.',
      whatsHappening: [
        'Adrenalin z dopoledne odezní a odpoledne často přijde únava nebo prázdno',
        'Mozek hledá, co dál kontrolovat, a začne se upínat na příznaky, které zatím nic neznamenají',
        'Strach z výsledku a radost z toho, že jste to zvládla, mohou existovat vedle sebe',
        'Blízcí se často ptají hned dnes, i když vy sama zatím nemáte co říct',
      ],
      reflection: 'Co bych dnes večer potřebovala nejvíc: být sama, být s někým, nebo aby se nikdo na nic neptal?',
      tip: 'Domluvte si s partnerem nebo kamarádkou jednu větu, kterou budete odpovídat na dotazy. Například že zatím není co říct a ozvete se sama. Ušetří vám to desítky vysvětlování.',
    },
    {
      id: 'beta-dc2-1',
      phases: ['beta_positive'],
      day: 2,
      headline: 'Komu říct o těhotenství a kdy',
      body: 'Pozitivní odběr je zpráva, kterou zatím nemusíte nikam posílat. Někomu pomůže říct to hned, jinému stačí jeden člověk a klid. Rozhodnutí je vaše a můžete ho kdykoli změnit.',
      whatsHappening: [
        'Zatím to ví jen klinika a vy, nikdo jiný o tom mluvit nemusí.',
        'Lidé, kteří věděli o transferu, se budou ptát sami.',
        'Kolegům stačí věta, že máte kontrolu u lékaře, důvod uvádět nemusíte.',
        'Co řeknete teď, už zpátky nevezmete.',
      ],
      task: 'Napište si tři jména lidí, kterým to chcete říct jako prvním. Zbytek počká.',
      reflection: 'Komu to chci říct kvůli sobě, a koho bych do toho zatím nezatahovala?',
      tip: 'Na dotěrné otázky si připravte jednu hotovou větu: „Máme kontrolu za pár dní, víc zatím nevím.“',
    },
    {
      id: 'beta-dc2-2',
      phases: ['beta_positive'],
      day: 3,
      headline: 'Špinění a krvácení: co dělat',
      body: 'Slabé špinění se u části žen po IVF objeví a nemusí znamenat, že je něco špatně. Zároveň platí, že žádné krvácení není důkaz, že je všechno v pořádku. Když si nejste jistá, volejte na kliniku, od toho tam jsou. Podporu nikdy nevysazujte sama, o tom rozhoduje lékař.',
      whatsHappening: [
        'Hnědé nebo slabě růžové špinění bývá po vaginální podpoře časté.',
        'Progesteronové čípky a gely dráždí sliznici a mohou špinění vyvolat samy.',
        'Klinika se ptá na barvu, množství a na to, jestli je s tím bolest.',
        'Množství se dá popsat podle toho, za jak dlouho se promočí vložka.',
      ],
      tip: 'Uložte si číslo na kliniku mezi oblíbené kontakty, ať ho v panice nehledáte.',
      callDoctorIf: [
        'Krvácení je jasně červené a sílí',
        'Promáčíte vložku za hodinu nebo rychleji',
        'Ke krvácení se přidá silná bolest, hlavně na jedné straně',
        'Máte teplotu nad 38 stupňů',
        'Točí se vám hlava, je vám na omdlení nebo vás bolí rameno',
      ],
    },
    {
      id: 'beta-dc2-3',
      phases: ['beta_positive'],
      day: 4,
      headline: 'Proč se podpora bere dál',
      body: 'Po IVF se hormonální podpora obvykle nevysazuje ještě několik týdnů, protože cyklus po stimulaci a odběru nefunguje jako přirozený. Kdy a jak se podpora ukončí, určuje výhradně klinika, ne příznaky ani to, jak se cítíte. Když vám lék dochází nebo vám nedělá dobře, zavolejte, forma i způsob podání se dají řešit.',
      whatsHappening: [
        'Progesteron se podává vaginálně, v tabletách nebo injekčně, podle rozpisu kliniky.',
        'Vaginální forma zanechává bílý výtok nebo drobky, to je zbytek nosiče.',
        'Vynechaná dávka se neřeší domácí úvahou, ale telefonem na kliniku.',
        'Únava, citlivá prsa a nafouklé břicho jdou často na vrub právě podpoře.',
      ],
      task: 'Zkontrolujte, na kolik dní vám léky zbývají, a objednejte je s předstihem.',
      tip: 'Nastavte si na dávky opakovaný budík. Ve stresu se čas snadno rozjede.',
    },
    {
      id: 'beta-dc2-4',
      phases: ['beta_positive'],
      day: 5,
      headline: 'Když už jste jednou o těhotenství přišla',
      body: 'Po ztrátě se pozitivní výsledek často neprožívá jako radost, ale jako zadržený dech. Tělo si pamatuje, jak to minule začalo, a hlídá každý signál. Nemusíte se nutit do nadšení, které necítíte. Opatrnost není špatné znamení, je to způsob, jak se chráníte.',
      whatsHappening: [
        'Vracejí se konkrétní vzpomínky: den, hodina, věta od lékaře.',
        'Kontrola na záchodě po každém čůrání je běžná reakce, ne selhání.',
        'Datum, kdy to minule skončilo, může v hlavě sedět jako hranice.',
        'Část žen si tentokrát nedovolí plánovat vůbec nic, a to je legitimní.',
      ],
      reflection: 'Co mi tehdy pomohlo přežít nejtěžší týden a co z toho mám i dnes?',
      tip: 'Řekněte na klinice, že máte za sebou ztrátu. Mění to způsob, jakým s vámi mluví, i to, jak brzy vás objednají.',
    },
    {
      id: 'beta-dc2-5',
      phases: ['beta_positive'],
      day: 6,
      headline: 'Noční hledání hodnot na internetu',
      body: 'Tabulky a diskuse vypadají jako odpověď, ale porovnáváte se s cizími čísly, cizím dnem odběru a cizí laboratoří. Každá laboratoř měří jinak a den odběru s výsledkem hýbe. Vaše hodnoty umí zařadit jen ten, kdo vidí celou vaši dokumentaci.',
      whatsHappening: [
        'Rozsahy v tabulkách jsou široké a navzájem se překrývají.',
        'Na fórech píší hlavně lidé s dramatickým průběhem, obyčejný nikdo nepopisuje.',
        'Hledání po půlnoci zvedá úzkost, i když nic nového nenajdete.',
        'Otázka „je to dost?“ má odpověď jen na klinice.',
      ],
      task: 'Zapište si otázku, kterou chcete položit sestře, místo abyste ji zadala do vyhledávače.',
      tip: 'Domluvte si sama se sebou hranici: hledání jen do osmi večer, pak už telefon odložíte.',
    },
    {
      id: 'beta-dc2-6',
      phases: ['beta_positive'],
      day: 7,
      headline: 'Běžný den: práce, pohyb, cesty',
      body: 'Většina žen se po IVF vrací k běžnému režimu a ležení v posteli se obvykle nedoporučuje. Co je vhodné konkrétně pro vás, ale patří klinice, hlavně pokud jste měla komplikovaný cyklus. Ptejte se adresně: sport, zvedání, sauna, dlouhá cesta autem, let.',
      whatsHappening: [
        'Chůze a běžná domácnost bývají v pořádku.',
        'Nárazová zátěž, kontaktní sporty a sauna se spíš odkládají.',
        'Práce ve směnách nebo s chemikáliemi se řeší individuálně.',
        'Neschopenku obvykle vypisuje váš lékař, ne reprodukční centrum.',
      ],
      task: 'Sepište tři otázky k běžnému režimu a položte je při nejbližším kontaktu s klinikou.',
      reflection: 'Co si zakazuji z vlastního strachu a co mi doopravdy zakázal lékař?',
    },
    {
      id: 'beta-dc2-7',
      phases: ['beta_positive'],
      day: 9,
      headline: 'Příznaky, které umí udělat i podpora',
      body: 'Citlivá prsa, únava, nevolnost i tahání v podbřišku umí vyvolat sama hormonální podpora. Z příznaků se proto nedá nic vyčíst, ani když jsou silné, ani když nejsou žádné. Nemít nic je stejně běžná varianta jako mít všechno naráz.',
      whatsHappening: [
        'Progesteron sám o sobě způsobuje ospalost a nafouklé břicho.',
        'Příznaky kolísají ze dne na den, aniž by to něco znamenalo.',
        'Kontrola prsou každou hodinu úzkost spíš zvyšuje.',
        'Informaci přinese až odběr nebo ultrazvuk, ne dnešní pocit.',
      ],
      reflection: 'Kolikrát jsem dnes kontrolovala své tělo a co mi to přineslo?',
      tip: 'Když se přistihnete při další kontrole, řekněte si nahlas, kdy přijde další skutečná informace.',
    },
    {
      id: 'beta-dc2-8',
      phases: ['beta_positive'],
      day: 11,
      headline: 'Partner to prožívá jinak',
      body: 'Muži často přepnou do režimu „hotovo, máme to“ ve chvíli, kdy vy teprve začínáte hlídat každý signál. Nebývá to lhostejnost, ale jiný způsob, jak zvládnout nejistotu. Řekněte konkrétně, co potřebujete, protože samo se to neuhádne.',
      whatsHappening: [
        'Partner nemá tělo, které mu každou hodinu posílá zprávy.',
        'Vaše mlčení si může vykládat jako klid.',
        'Věta „neboj, to bude dobré“ bývá myšlená jako pomoc, i když tak nezní.',
        'Představa o tom, komu se to řekne, se u dvou lidí často liší.',
      ],
      task: 'Vyslovte jednu konkrétní prosbu, třeba aby na kliniku kvůli termínu zavolal on.',
      reflection: 'Co bych od něj potřebovala, kdybych to uměla říct jednou větou?',
    },
    {
      id: 'beta-dc2-9',
      phases: ['beta_positive'],
      dayRange: [9, 19],
      headline: 'Zbylá zamražená embrya a co dál',
      body: 'Pokud po transferu zůstala zamražená embrya, jejich uskladnění běží dál a je zpoplatněné, obvykle na roční období. Teď nemusíte nic rozhodovat, stačí vědět, do kdy máte skladování zaplacené. O tom, co s nimi jednou bude, se rozhoduje s odstupem, ne v tomhle týdnu.',
      whatsHappening: [
        'Klinika si o prodloužení řekne dopisem nebo e-mailem, často v nevhodnou chvíli.',
        'Rozhodnutí o dalším osudu embryí podepisují obvykle oba partneři.',
        'Lhůty a podmínky se u jednotlivých klinik liší, najdete je ve smlouvě.',
        'Zamražená embrya jsou samostatná věc, na dnešním čekání nic nemění.',
      ],
      task: 'Najděte ve smlouvě datum, do kdy je skladování uhrazené, a zapište si ho do kalendáře.',
      reflection: 'Chci se tím teď zabývat, nebo si to vědomě odkládám na později?',
    },
    {
      id: 'beta-dc2-10',
      phases: ['beta_positive'],
      dayRange: [14, 23],
      headline: 'Ráno před prvním ultrazvukem',
      body: 'Vyšetření bývá vaginální, takže plný močový měchýř většinou potřeba není, ale ověřte si předem, jak to má vaše klinika. Vezměte si zprávy, seznam léků a připravené otázky, protože v ordinaci se obvykle vypaří. Pokud se bojíte, že po vyšetření nebudete chtít řídit, domluvte si odvoz.',
      whatsHappening: [
        'Vyšetření samo trvá krátce, čekárna často déle.',
        'Někdo mluví během vyšetření, jiný lékař až na konci, mlčení nic neznamená.',
        'Sukně bývá praktičtější než overal.',
        'Doprovod může počkat venku a stejně být užitečný po cestě domů.',
      ],
      task: 'Napište si tři otázky do poznámek v telefonu a otevřete je hned v ordinaci.',
      tip: 'Zeptejte se rovnou, kdy má být další kontrola a kdo ji bude dělat.',
    },
    {
      id: 'beta-dc2-11',
      phases: ['beta_positive'],
      dayRange: [17, 32],
      headline: 'Co ultrazvuk ukáže a co ještě ne',
      body: 'První ultrazvuk sleduje hlavně to, kde je nález uložený a jak odpovídá vypočtenému termínu. Některé věci se v tomhle období ještě zobrazit nemusí a lékař vás může pozvat na kontrolu za pár dní. Pozvání na kontrolu samo o sobě není odpověď, je to posun v čase. Snímek umí vyložit jen lékař. Z fotky pořízené v ordinaci nic nevyčtete.',
      whatsHappening: [
        'Termín se může po ultrazvuku posunout oproti tomu, co jste si počítala.',
        'Přístroj i zkušenost vyšetřujícího ovlivňují, co je v daný den vidět.',
        'Kontrolní ultrazvuk za několik dní je běžný postup, ne špatné znamení.',
        'Podpora pokračuje beze změny, dokud lékař nerozhodne jinak.',
      ],
      reflection: 'Co konkrétně chci od lékaře slyšet, abych odcházela s jasnou informací?',
      callDoctorIf: [
        'Máte silnou bolest v podbřišku, hlavně na jedné straně',
        'Krvácíte jasně červenou krví a sílí to',
        'Bolí vás rameno nebo špička lopatky',
        'Je vám na omdlení nebo se vám opakovaně točí hlava',
        'Máte teplotu nad 38 stupňů',
      ],
    },
    {
      ...
      phases: ['beta_positive'],
      dayRange: [19, 55],
      headline: 'Uzavření IVF části vaší cesty',
      body: 'Až vás reprodukční centrum předá do běžné péče, hodí se mít IVF část uzavřenou na jednom místě: protokoly, hodnoty, zprávy. Kdy a jestli k předání dojde, řekne vaše klinika. Zbylá zamražená embrya zůstávají evidovaná v centru a jejich osud se řeší zvlášť.',
      whatsHappening: [
        'Poslední zpráva z kliniky patří k dokumentaci, kterou předáte dál.',
        'Podpora se ukončuje podle pokynu lékaře, ne podle data propuštění.',
        'Zamražená embrya a smlouva o skladování běží dál nezávisle na tom.',
        'Objednat se ke gynekologovi je na vás, klinika to obvykle nedělá za vás.',
      ],
      task: 'Založte si jednu složku a nahrajte do ní poslední zprávu z kliniky. Zbytek můžete doplnit kdykoliv později.',
      reflection: 'Co si z téhle části cesty chci nechat a co už dál nosit nechci?',
      tip: 'Napište si dvě věty o tom, jaká tahle část byla. Za rok si na většinu detailů nevzpomenete.',
    },
  ],
  encouragements: [
    {
