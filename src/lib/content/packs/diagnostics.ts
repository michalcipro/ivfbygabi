...
> Text nenahrazuje genetické poradenství ani psychologickou péči. Výklad výsledků patří klinickému genetikovi.`,
  ...
  dailyCards: [
    ...
    },
    {
      ...
      phases: ['genetic_testing'],
      dayRange: [0, 6],
      headline: 'Co karyotyp ukáže a co ne',
      body: 'Karyotyp je fotka vašich chromozomů: kolik jich je a jestli nemají přeskupenou strukturu. Neřekne nic o kvalitě vajíček, o tom, jak zareagujete na stimulaci, ani o většině jednotlivých genů. Je to široký pohled zdálky, ne detailní čtení. Proto se často doplňuje dalšími testy, které cílí na konkrétní otázky.',
      whatsHappening: [
        'Z krve se nechají buňky několik dní růst, teprve pak se dají chromozomy hodnotit',
        'Hodnotí se počet chromozomů a jestli nejsou části přeneseny jinam',
        'Nález typu vyvážená translokace znamená, že jste zdravá, ale předání může být složitější',
        'Karyotyp se dělá oběma partnerům, protože přestavbu chromozomů může mít kterýkoli z vás a projeví se stejně',
      ],
      task: 'Napište si do poznámek v aplikaci BlooMia, která vyšetření máte objednaná a kdy jste byla na odběru.',
      tip: 'Zeptejte se na klinice rovnou, jestli výsledek dostanete písemně, nebo jen ústně na konzultaci. Ušetří vám to pozdější dohadování.',
    },
    {
      id: 'gen-dc2-2',
      phases: ['genetic_testing'],
      dayRange: [0, 9],
      headline: 'Proč to trvá týdny, ne dny',
      body: 'U karyotypu se buňky z vaší krve musí nejdřív namnožit v laboratoři, což samo o sobě trvá dny. Pak přichází hodnocení pod mikroskopem, kontrola a psaní zprávy. U genetiky se navíc často čeká na sběr více vzorků, aby se dávka mohla zpracovat najednou. Čekání není známkou toho, že se něco našlo.',
      whatsHappening: [
        'Délka není dána vaší frontou, ale technologií kultivace buněk',
        'Molekulární testy jako trombofilní mutace mívají kratší termín než karyotyp',
        'Termín zadaný klinikou je odhad laboratoře, ne slib',
        'Zprávy se často uvolňují jen s genetikem, který je umí vysvětlit',
      ],
      reflection: 'Co konkrétně mi na čekání vadí nejvíc: nejistota, nebo to, že zatím nemůžeme pokračovat?',
    },
    {
      id: 'gen-dc2-3',
      phases: ['genetic_testing'],
      dayRange: [1, 12],
      headline: 'Přenašečství není nemoc',
      body: 'U řady dědičných onemocnění platí, že člověk může nést jednu změněnou kopii genu a být přitom celý život zdravý. Nemoc se projeví, až když se sejdou dvě takové kopie, tedy od obou rodičů. Být přenašečkou tedy neznamená být nemocná ani že jste něco udělala špatně. Znamená to jen informaci, se kterou se dá pracovat.',
      whatsHappening: [
        'Přenašečů běžných recesivních onemocnění je v populaci hodně, aniž by o tom věděli',
        'Riziko se počítá až z kombinace obou partnerů, ne z jednoho výsledku',
        'Pokud je přenašeč jen jeden z vás, situace bývá jiná než když oba',
        'U některých nálezů existuje cílené testování embryí, u jiných se postupuje jinak',
      ],
      tip: 'Slovo přenašečství si nechte vysvětlit na konzultaci vlastními slovy. Genetik je zvyklý to říkat srozumitelně, když se zeptáte.',
    },
    {
      id: 'gen-dc2-4',
      phases: ['genetic_testing'],
      dayRange: [2, 16],
      headline: 'Trombofilie: slova, která vypadají hrozivě',
      body: 'Trombofilní mutace jsou změny ovlivňující srážlivost krve. Vyskytují se poměrně často a u velké části lidí se nikdy nijak neprojeví. Jestli má nález ve vašem případě nějaký důsledek, závisí na typu mutace, na tom, jestli jde o jednu, nebo o obě kopie genu (heterozygotní, nebo homozygotní nález), a hlavně na vaší osobní a rodinné anamnéze. To spojení umí udělat jen lékař, který vidí celý obraz.',
      whatsHappening: [
        'Testuje se obvykle několik konkrétních mutací, ne srážlivost jako celek',
        'Stejný název mutace může u dvou žen znamenat úplně jiné doporučení',
        'Součástí bývají i laboratorní hodnoty, které kolísají a opakují se',
        'Nález sám o sobě není diagnóza, tou je až závěr lékaře',
      ],
      callDoctorIf: [
        'Objeví se otok, bolest nebo zarudnutí jedné dolní končetiny',
        'Máte náhlou dušnost nebo bolest na hrudi',
        'Máte silnou bolest hlavy, která neustupuje po běžném léku',
        'V rodině se objevila trombóza nebo plicní embolie a klinika o tom neví',
        'Užíváte léky na srážlivost a nikdo z týmu o nich neví',
      ],
    },
    {
      id: 'gen-dc2-5',
      phases: ['genetic_testing'],
      dayRange: [4, 19],
      headline: 'PGT-A a PGT-M nejsou totéž',
      body: 'PGT-A hledá odchylky v počtu chromozomů u embryí, tedy jestli jich není víc nebo míň, než má být. PGT-M se dělá, když je v rodině známá konkrétní dědičná nemoc, a cílí přesně na ni. Každé z nich odpovídá na jinou otázku a jinak se indikuje. Které z nich má u vás smysl, vychází z vašich výsledků a historie, ne z toho, co se nejvíc dělá.',
      whatsHappening: [
        'PGT-M se často připravuje na míru rodině a příprava sama trvá týdny',
        'PGT-A se dělá až u embryí v pátém nebo šestém dni vývoje',
        'Ne každá klinika nabízí obojí, někdy se vzorky posílají jinam',
        'Obě metody vyžadují, aby embrya vydržela do stadia, kdy se dá odebrat vzorek',
      ],
      task: 'Sepište si dvě otázky pro genetika: proč právě tato metoda a co bude, když embryí bude málo.',
    },
    {
      id: 'gen-dc2-6',
      phases: ['genetic_testing'],
      dayRange: [5, 23],
      headline: 'PGT mění počet embryí k přenosu',
      body: 'Testování embryí neurčuje, kolik jich vznikne. Určuje, kolik z nich se dostane do skupiny doporučené k přenosu. Pro část párů to znamená, že po testování zbude méně embryí, než čekali. Je dobré o tom vědět předem, aby to nebylo překvapení uprostřed cyklu.',
      whatsHappening: [
        'Ne každé embryo se dopracuje do stadia, kdy se dá vzorek odebrat',
        'Vzorek se odebírá z buněk, ze kterých se tvoří placenta, ne z budoucího plodu',
        'Po odběru se embrya zamrazí a čeká se na výsledek, přenos je proto odložený',
        'Výsledek může být i nejednoznačný nebo se u jednoho embrya nepovede vůbec',
      ],
      reflection: 'Jak bych se cítila, kdyby po testování zbylo méně embryí, než jsme čekali, a co bych chtěla vědět dřív, než to nastane?',
    },
    {
      id: 'gen-dc2-7',
      phases: ['genetic_testing'],
      dayRange: [7, 25],
      headline: 'Mozaicismus není ano ani ne',
      body: 'U některých embryí laboratoř najde směs buněk s různým počtem chromozomů. Tomu se říká mozaicismus a nespadá to čistě do kategorie v pořádku ani do kategorie odchylka. Přístup k takovým embryím se mezi pracovišti liší a odborná diskuse o nich stále probíhá. Rozhodnutí, co s nimi, je vždy na konzultaci s genetikem a embryologem, ne na výkladu jednoho řádku ve zprávě.',
      whatsHappening: [
        'Vzorek je jen několik buněk, nemusí odpovídat celému embryu',
        'Rozlišuje se podíl odchylných buněk a to, kterého chromozomu se týkají',
        'Některá pracoviště taková embrya k přenosu zvažují, jiná mají jiný postup',
        'U mozaiky se obvykle domlouvá i další sledování v případném těhotenství',
      ],
      tip: 'Když ve zprávě uvidíte slovo mozaika, nehledejte ho na internetu. Poznamenejte si ho a zeptejte se na konzultaci, co znamená konkrétně u vašeho embrya.',
    },
    {
      id: 'gen-dc2-8',
      phases: ['genetic_testing'],
      dayRange: [8, 30],
      headline: 'Imunologie: kde končí shoda odborníků',
      body: 'Část imunologických vyšetření v reprodukci má jasné místo a jasné závěry. U jiné části se odborníci na výklad a na léčbu neshodují a doporučení se mezi pracovišti liší. Není to chyba vaší kliniky, je to stav poznání. Vyplatí se ptát, co konkrétně z výsledku plyne pro vaši léčbu a jak jistá ta souvislost je.',
      whatsHappening: [
        'Panely vyšetření se liší klinika od kliniky, srovnávat je není snadné',
        'Některé hodnoty kolísají podle fáze cyklu a podle infektu v posledních týdnech',
        'Z jednoho odběru se často závěr dělat nedá, opakování je běžné',
        'Léčba na základě imunologie se u části postupů stále vyhodnocuje',
      ],
      task: 'Zeptejte se na klinice, které z vašich imunologických testů ovlivní konkrétní krok léčby a které jsou informativní.',
    },
    {
      id: 'gen-dc2-9',
      phases: ['genetic_testing'],
      dayRange: [10, 32],
      headline: 'Když se nález týká hlavně jeho',
      body: 'Někdy vyjde nález u partnera a on ho nese těžko. Muži často reagují stažením nebo tím, že to zlehčí. Není potřeba to hned řešit, ale je dobré nechat prostor a nemluvit o tom jako o vině. Genetická informace je věc náhody, ne charakteru.',
      whatsHappening: [
        'Nález u partnera nemění to, že do léčby jdete oba',
        'Řada mužů se nikdy nesetkala s tím, že by jejich zdraví někdo takhle rozebíral',
        'Zprávu často vysvětlí genetik oběma najednou lépe než jeden druhému doma',
        'Mlčení nemusí znamenat nezájem, u části lidí je to způsob, jak zpracovat zprávu',
      ],
      reflection: 'Co bych potřebovala od partnera slyšet, kdyby ten nález vyšel u mě?',
    },
    {
      id: 'gen-dc2-10',
      phases: ['genetic_testing'],
      dayRange: [11, 37],
      headline: 'Založte si složku pro druhý názor',
      body: 'Výsledky genetiky a imunologie se často ukazují na jiném pracovišti, ať už kvůli druhému názoru nebo změně kliniky. Dohledávat je po roce po telefonu je nepříjemné. Vyplatí se sbírat je průběžně a v podobě, kterou jde poslat mailem. Bude to pár minut teď a hodně ušetřeného času později.',
      whatsHappening: [
        'Zpráva má být čitelná celá, včetně hlavičky laboratoře a data odběru',
        'Vlastní vyfocený papír je plnohodnotný, pokud je ostrý a nic není useknuté',
        'Užitečné je poznamenat si i jméno lékaře, který vám nález vysvětloval',
        'Části vyšetření se neopakují, pokud předložíte původní zprávu',
      ],
      task: 'Vytvořte si v telefonu jednu složku, pojmenujte ji podle vyšetření a nahrajte do ní všechno, co už máte.',
    },
    {
      id: 'gen-dc2-11',
      phases: ['genetic_testing'],
      dayRange: [17, 43],
      headline: 'Čekání jako čas na odložené papíry',
      body: 'Čekání na výsledky je mrtvý čas jen zdánlivě. Dají se v něm vyřídit věci, které by později zdržovaly: očkování, zubař, kontrola štítné žlázy, papíry pro pojišťovnu. Nejde o to zaplnit každý den úkolem. Jde o to, aby vás pak nic zbytečně nebrzdilo.',
      whatsHappening: [
        'Některá vyšetření mají omezenou platnost a je dobré hlídat data',
        'Zubní ošetření se v těhotenství odkládá hůř než teď',
        'Úprava léků na jiná onemocnění se řeší s příslušným lékařem, ne na vlastní pěst',
        'Papírování s pojišťovnou má vlastní lhůty, které se s cyklem nesejdou samy',
      ],
      tip: 'Vyberte si z toho jednu věc na tento týden. Seznam, který se dá splnit celý najednou, se obvykle neplní vůbec.',
    },
    {
      id: 'gen-dc2-12',
      phases: ['genetic_testing'],
      dayRange: [21, 54],
      headline: 'Když nález nic nevysvětlí',
      body: 'U části párů projdou všechna vyšetření a nenajde se nic, co by dosavadní průběh vysvětlovalo. Je to zvláštní zklamání: dobrá zpráva, která nepomůže. Neznamená to, že jste testy podstoupili zbytečně. Vyloučení konkrétních příčin je informace, podle které se dá dál postupovat, i když se to tak zrovna necítí.',
      whatsHappening: [
        'Normální nález mění plán léčby stejně jako nález pozitivní, jen jiným směrem',
        'Medicína zatím nezná příčinu u všech případů a nepředstírá to',
        'Některé otázky lze později otevřít znovu, pokud se objeví nový důvod',
        'Zpráva bez nálezu má svou hodnotu i na jiném pracovišti, ušetří opakování',
      ],
      reflection: 'Co mi tenhle výsledek dal, když mi nedal odpověď?',
    },
  ],
  encouragements: [
    {
