...
> Seznam nenahrazuje lékařskou péči. Slouží jen k tomu, abyste z konzultace odešla s informacemi, které potřebujete.`,
  ...
  dailyCards: [
    ...
    },
    {
      ...
      dayRange: [0, 5],
      headline: 'První dny po negativním výsledku',
      body: 'Výsledek přišel a nic dalšího se po vás dnes nechce. Nemusíte plánovat další krok, nemusíte být statečná a nemusíte to nikomu vysvětlovat. Léky ze své vůle nevysazujte, o progesteronu i o všem ostatním rozhoduje lékař. Dnešek stačí přežít, hodnotit ho nemusíte.',
      whatsHappening: [
        'Progesteron a estrogeny z podpory odcházejí z těla postupně, ne ze dne na den.',
        'Slzy můžou přijít se zpožděním, klidně až za dva dny.',
        'Únava po odběru a transferu z těla ještě nevyprchala.',
        'Potřeba znát hned důvod bývá silná, odpověď přijde až na kontrole.',
      ],
      task: 'Napište si do telefonu jednu větu: co dnes zvládnu a co odkládám na příští týden.',
      reflection: 'Co dnes potřebuji nejvíc, i kdyby to bylo jen ticho?',
      tip: 'Pokud vás napadají myšlenky, že byste si ublížila, nevolejte kliniku, ale linku první psychické pomoci 116 123. Je zdarma, nonstop a anonymně. Při bezprostředním ohrožení volejte 155.',
      callDoctorIf: [
        'krvácíte silně a musíte měnit vložku každou hodinu',
        'máte teplotu nad 38 stupňů',
        'bolest břicha se stupňuje nebo vystřeluje do ramene',
        'nevíte, kdy a jak máte ukončit progesteron nebo další léky',
      ],
    },
    {
      id: 'mezi-dc2-2',
      phases: ['waiting_next_attempt'],
      dayRange: [0, 8],
      headline: 'Menstruace po cyklu bývá jiná',
      body: 'První krvácení po neúspěšném cyklu bývá silnější, bolestivější nebo naopak divně slabé. Může přijít dřív i později, než jste zvyklá, a často jsou v něm sraženiny. U části žen se ještě jeden nebo dva další cykly nechovají jako obvykle. Jak to vypadalo, si zapište, lékař se na to na kontrole ptá.',
      whatsHappening: [
        'Po ukončení progesteronu přichází krvácení obvykle během několika dnů.',
        'Sliznice byla během cyklu vybudovaná silnější, odchází proto déle.',
        'Křeče bývají ostřejší než u běžné menstruace.',
        'Nálada se s poklesem hormonů propadá i bez zjevného důvodu.',
      ],
      task: 'Zapište si do aplikace BlooMia první den krvácení, jeho sílu a bolest.',
      tip: 'Připravte si nahřívací polštářek a volné oblečení dřív, než to začne.',
      callDoctorIf: [
        'promáčíte vložku za hodinu a trvá to několik hodin po sobě',
        'krvácení nepřišlo do dvou týdnů po ukončení podpory',
        'máte horečku nebo zapáchající výtok',
        'bolest nezvládáte běžnými léky proti bolesti',
        'motá se vám hlava nebo je vám na omdlení',
      ],
    },
    {
      id: 'mezi-dc2-3',
      phases: ['waiting_next_attempt'],
      dayRange: [0, 10],
      headline: 'Až se budete vracet mezi lidi',
      body: 'Do práce se vracíte s tím, že o tom mluvit nechcete, a někdo se stejně zeptá. Pomáhá mít předem jednu větu, kterou řeknete bez přemýšlení. Třeba: teď to nevyšlo, víc o tom mluvit nechci, děkuju. Nikomu nedlužíte podrobnosti.',
      whatsHappening: [
        'Soustředění bývá první týden roztříštěné, chyby v drobnostech jsou běžné.',
        'Otázka „tak co?“ na chodbě může spustit slzy během vteřiny.',
        'Únava po hormonech doznívá i po skončení léčby.',
        'Tělo si zvyklo na režim píchání a kontrol, prázdné dny působí divně.',
      ],
      task: 'Napište si tu jednu větu doslova a jednou si ji přečtěte nahlas.',
      reflection: 'Komu v práci můžu říct pravdu a komu stačí zdvořilá odpověď?',
      tip: 'Na první den návratu si naplánujte úkoly, které zvládnete i s vypnutou hlavou.',
    },
    {
      id: 'mezi-dc2-4',
      phases: ['waiting_next_attempt'],
      dayRange: [2, 12],
      headline: 'Partner truchlí v jiném tempu',
      body: 'Může vypadat, že to nese líp, a přitom jen nechce přitěžovat. Někdo se vrhne do práce, jiný do plánů na další pokus, další mlčí. Rozdílné tempo neznamená, že mu na tom nezáleželo. Zkuste říct, co potřebujete vy, místo hádání, co potřebuje on.',
      whatsHappening: [
        'Vaše tělo prošlo zákroky, jeho ne, prožitek je proto jiný.',
        'Muži často přeskakují rovnou k řešení, protože bezmoc se snáší hůř.',
        'Sex může být na čas komplikovaný pro oba, každý z jiného důvodu.',
        'Věta „aspoň víme, že to jde“ dokáže zranit, i když byla myšlená jako podpora.',
      ],
      task: 'Řekněte partnerovi jednu konkrétní věc, kterou pro vás tento týden může udělat.',
      reflection: 'Co jsem mu neřekla, protože jsem čekala, že to pozná sám?',
    },
    {
      id: 'mezi-dc2-5',
      phases: ['waiting_next_attempt'],
      dayRange: [4, 15],
      headline: 'Proč klinika chce pauzu mezi cykly',
      body: 'Pauza není trest ani ztracený čas. Vaječníky se po stimulaci potřebují vrátit do klidu a děloha si potřebuje projít vlastním cyklem. Délku určuje klinika podle protokolu, průběhu cyklu a toho, jestli půjdete do kryo transferu nebo do nové stimulace. Zeptejte se konkrétně, na co se čeká, ať víte, co sledovat.',
      whatsHappening: [
        'Vaječníky po stimulaci bývají ještě zvětšené a citlivé.',
        'U kryo transferu se obvykle čeká kratší dobu než u nové stimulace.',
        'Někdy se čeká na doplňkové vyšetření, ne na tělo.',
        'Termín dalšího startu se většinou váže na první den menstruace.',
      ],
      task: 'Napište si otázku pro kliniku: co přesně musí být splněné, abychom mohli začít.',
      tip: 'Odpověď si nechte poslat i písemně, po telefonu se detaily snadno ztratí.',
    },
    {
      id: 'mezi-dc2-6',
      phases: ['waiting_next_attempt'],
      dayRange: [7, 18],
      headline: 'Když kamarádka oznámí těhotenství',
      body: 'Závist v téhle situaci není ošklivost, je to bolest s jiným jménem. Můžete mít kamarádku ráda a zároveň nezvládnout její ultrazvuk ve skupinovém chatu. Smíte si ztlumit konverzaci, odmítnout oslavu i neotevřít fotky. Omlouvat se za to nemusíte.',
      whatsHappening: [
        'Oznámení těhotenství bolí nejvíc, když přijde bez varování v telefonu.',
        'Oslavy a křtiny bývají těžší než samotná zpráva.',
        'Vztek na kamarádku často střídá vina, že ho vůbec cítíte.',
        'Odstup na pár měsíců přátelství obvykle nezničí.',
      ],
      task: 'Ztlumte si dnes jednu konverzaci nebo profil, který vás pravidelně sráží.',
      reflection: 'Koho mám v okolí, u koho nemusím nic hrát?',
    },
    {
      id: 'mezi-dc2-7',
      phases: ['waiting_next_attempt'],
      dayRange: [8, 22],
      headline: 'Peníze a další krok bez dohadů',
      body: 'Rozhodování o dalším pokusu jde špatně, když nevíte, kolik co stojí. Sepište si, co bylo hrazené pojišťovnou, co jste doplácela a co by přibylo příště. Nejde o to spočítat cenu dítěte. Jde o to, abyste se rozhodovala podle čísel na papíře, ne podle úzkosti ve tři ráno.',
      whatsHappening: [
        'Počet hrazených cyklů a jejich podmínky ověříte na klinice i u pojišťovny.',
        'Léky, zamrazení a doplňková vyšetření se často doplácí zvlášť.',
        'Skladování zamrazených embryí se platí opakovaně, obvykle jednou za rok.',
        'Účtenky a faktury se po pár měsících dohledávají hůř.',
      ],
      task: 'Založte si jednu složku, papírovou nebo v telefonu, a dejte do ní doklady, které máte dnes po ruce.',
      reflection: 'Kolik jsme ochotní vydat na další krok, aniž bychom se dostali do úzkých?',
    },
    {
      id: 'mezi-dc2-8',
      phases: ['waiting_next_attempt'],
      dayRange: [10, 25],
      headline: 'Tělo, které smí zase být vaše',
      body: 'Několik měsíců bylo vaše tělo pracovištěm: injekce, odběry, ultrazvuky. Teď přišly týdny, kdy po něm nikdo nic nechce. Pohyb, spánek ani jídlo si nemusíte zasloužit a nemusíte je optimalizovat. Doplňky stravy a větší změny režimu proberte s lékařem, ne s internetovou diskuzí.',
      whatsHappening: [
        'Modřiny po injekcích a citlivá prsa odeznívají během několika týdnů.',
        'Váha se po hormonech u části žen vrací pomalu, i když jíte stejně.',
        'Chuť na pohyb se často vrátí dřív než chuť na plánování.',
        'Spánek se srovnává, jakmile ubydou noční kontroly kalendáře.',
      ],
      task: 'Jděte se na deset minut projít bez cíle a bez počítání kroků.',
      tip: 'Kávu a alkohol v pauze řešte podle domluvy s lékařem, ne podle pocitu viny.',
    },
    {
      id: 'mezi-dc2-9',
      phases: ['waiting_next_attempt'],
      dayRange: [14, 29],
      headline: 'Víkend, kdy se neřeší léčba',
      body: 'Vyberte si dva dny, kdy neotevřete diskuzní fórum ani kalendář cyklů. Není to útěk, je to údržba. Hlava si potřebuje ověřit, že jste pořád i někdo jiný než pacientka. Když myšlenka přijde, nechte ji projít a vraťte se k tomu, co zrovna děláte.',
      whatsHappening: [
        'Mozek si po měsících čekání odvyká hledat příznaky pomalu.',
        'První hodiny bez vyhledávání bývají nejtěžší, pak to povolí.',
        'Konkrétní plán funguje líp než předsevzetí na nic nemyslet.',
        'Změna prostředí zabírá u části žen víc než odpočinek doma.',
      ],
      task: 'Domluvte si na tento víkend jednu konkrétní věc, která s léčbou nesouvisí.',
      reflection: 'Co mě bavilo, než se všechno začalo točit kolem termínů?',
    },
    {
      id: 'mezi-dc2-10',
      phases: ['waiting_next_attempt'],
      dayRange: [17, 35],
      headline: 'Kdy vyhledat pomoc s psychikou',
      body: 'Smutek po neúspěšném cyklu je normální reakce, ne porucha. Existuje ale hranice, za kterou už nemá smysl to nést sama. Pokud se týdny nezvedáte, nefungujete v práci ani doma, ozvěte se odborníkovi. Řada klinik má psychologa se zkušeností s neplodností, ptejte se přímo na to.',
      whatsHappening: [
        'Truchlení nemá pevnou délku, ale v čase se obvykle proměňuje.',
        'Nespavost, která trvá týdny, zhoršuje všechno ostatní.',
        'Panika před vstupem do čekárny je častější, než se o ní mluví.',
        'Terapie nevylučuje pokračování v léčbě, jde souběžně.',
      ],
      tip: 'Při domlouvání terapeuta rovnou řekněte, že jde o neplodnost. Ušetříte si vysvětlování.',
      callDoctorIf: [
        'myslíte na to, že byste si ublížila nebo že byste tu radši nebyla',
        'déle než dva týdny nezvládáte základní fungování, jídlo, hygienu, práci',
        'nespíte několik týdnů nebo se budíte s panikou',
        'začala jste víc pít nebo brát léky na uklidnění bez doporučení lékaře',
        'úzkost vám brání jít na domluvenou kontrolu',
      ],
    },
    {
      id: 'mezi-dc2-11',
      phases: ['waiting_next_attempt'],
      dayRange: [20, 61],
      headline: 'Co po cyklu zůstalo v kryu',
      body: 'Pokud vám z cyklu zůstala zamrazená embrya nebo vajíčka, další pokus vypadá jinak než ten první. Kryo transfer bývá kratší, s menším množstvím léků a bez odběru. Kolik jich máte a jak dlouho je klinika skladuje, si nechte napsat černé na bílém. Co ta čísla znamenají pro váš postup, vyhodnotí lékař.',
      whatsHappening: [
        'Skladování se obvykle prodlužuje smlouvou a platbou na další období.',
        'Klinika vede záznam o počtu i o stadiu zamrazených embryí.',
        'Příprava na kryo transfer bývá časově kratší než celá stimulace.',
        'Rozhodnutí o dalším osudu embryí nemusíte dělat teď hned.',
      ],
      task: 'Vyžádejte si mailem od kliniky písemný přehled toho, co máte uložené a do kdy.',
    },
    {
      id: 'mezi-dc2-12',
      phases: ['waiting_next_attempt'],
      dayRange: [26, 155],
      headline: 'Když se pauza protáhla na měsíce',
      body: 'Někdy se čekání natáhne kvůli vyšetření, pořadníku, penězům nebo prostě proto, že jste ještě nechtěla. Dlouhá pauza není promarněný čas a nemusíte ji nikomu obhajovat. Život mezitím běžel dál a část otázek se možná posunula. Až budete chtít vědět, kde stojíte, začněte jednou schůzkou, ne rozhodnutím na celý rok.',
      whatsHappening: [
        'Některá vyšetření mají omezenou platnost a po čase se opakují.',
        'Odstup od posledního cyklu může změnit doporučený postup, posoudí ho lékař.',
        'Chuť pokračovat se často vrací ve vlnách, ne najednou.',
        'Klinika po delší pauze obvykle chce novou vstupní kontrolu.',
      ],
      reflection: 'Chci teď zjišťovat možnosti, nebo si ještě potřebuji nechat čas?',
      tip: 'Objednání na konzultaci vás k ničemu nezavazuje. Můžete jen sbírat informace.',
    },
    {
      id: 'opak-dc2-1',
      phases: ['repeated_failure'],
      dayRange: [0, 11],
      headline: 'Únava z opakování je jiná než smutek',
      body: 'Po prvním neúspěchu bolí ztráta. Po několikátém se k ní přidává vyčerpání ze samotného opakování: znovu ty samé kroky, znovu to samé čekání. Ta únava není slabost ani ztráta odhodlání, je to logický důsledek toho, kolik už jste toho absolvovala.',
      whatsHappening: [
        'Tělo po doběhnutí podpory může reagovat krvácením i výkyvy nálady',
        'Hlava se vrací k detailům cyklu a hledá, co bylo jinak',
        'Chuť mluvit o tom kolísá ze dne na den a to je v pořádku',
        'Plánovací konzultace na klinice bývá až s odstupem, teď se nerozhoduje',
      ],
      task: 'Napište si tři věci, které vám tenhle týden uberou ze zátěže. Jednu z nich dnes udělejte.',
      reflection: 'Co dnes zvládnu, aniž bych se musela přemáhat?',
      tip: 'Pokud vás napadají myšlenky, že byste si ublížila, nevolejte kliniku, ale linku první psychické pomoci 116 123. Je zdarma, nonstop a anonymně. Při bezprostředním ohrožení volejte 155.',
      callDoctorIf: [
        'Krvácíte silněji než při běžné menstruaci a promáčíte vložku během hodiny',
        'Máte teplotu nad 38 stupňů',
        'Bolest břicha se stupňuje a nepolevuje v klidu',
        'Nevíte jistě, kdy a jak máte ukončit hormonální podporu',
      ],
    },
    {
      id: 'opak-dc2-2',
      phases: ['repeated_failure'],
      dayRange: [0, 17],
      headline: 'Proč slova o dalším pokusu bolí',
      body: 'Na klinice zazní „zkusíme to znovu“ jako logický další krok. Vy ale slyšíte, že se to, co jste právě prožila, má celé opakovat. Obojí může platit najednou a tu větu nemusíte přijmout hned v ordinaci.',
      whatsHappening: [
        'Pro tým je to plán, pro vás další kolo injekcí, čekání a výsledků',
        'Slovo pokus zlehčuje něco, co stálo měsíce života',
        'Souhlas často padne dřív, než si to stihnete srovnat v hlavě',
        'Rozmyslet se do dalšího cyklu je běžné, ne zdržování',
      ],
      task: 'Určete si den, kdy se k rozhodnutí vrátíte. Do té doby ho nemusíte otevírat.',
      reflection: 'Co bych potřebovala vědět, než na další krok kývnu?',
      tip: 'Otázky na kontrolu si napište předem. V ordinaci se dobře ptá jen ten, kdo má seznam.',
    },
    {
      id: 'opak-dc2-3',
      phases: ['repeated_failure'],
      dayRange: [1, 27],
      headline: 'Když lékař řekne, že nález je v normě',
      body: '„V normě“ neznamená „víme proč“. Znamená, že v provedených vyšetřeních se nenašla odchylka, kterou daná metoda umí zachytit. U části opakovaných neúspěchů zůstává vysvětlení otevřené a je to nepříjemné pro vás i pro lékaře.',
      whatsHappening: [
        'Normální výsledek vylučuje konkrétní příčinu, ne všechny možné',
        'Některá vyšetření se zvažují až po určitém počtu neúspěšných přenosů',
        'Doporučení se mezi pracovišti liší, protože důkazy nejsou jednoznačné',
        'Věta o tom, že se nic nenašlo, bývá těžší než jasná diagnóza',
      ],
      task: 'Sepište si, jaká vyšetření už proběhla, a na příští kontrole se zeptejte, co se ještě zvažuje.',
      reflection: 'Které nezodpovězené otázce se pořád vracím?',
    },
    {
      id: 'opak-dc2-4',
      phases: ['repeated_failure'],
      dayRange: [4, 40],
      headline: 'Druhý názor není nedůvěra k lékaři',
      body: 'Vyžádat si konzultaci na jiném pracovišti je běžná součást medicíny, ne stížnost. Někdy dosavadní postup potvrdí a i to má cenu, protože ubyde otázka „co kdyby“. Na konzultaci si vezměte kompletní dokumentaci, bez ní stojí druhý názor na dohadech.',
      whatsHappening: [
        'Zprávy z cyklů, protokoly stimulace i laboratorní nálezy máte právo dostat',
        'Jiné pracoviště může volit jiný protokol nebo jiné načasování',
        'Konzultace neznamená, že tam musíte přejít',
        'Objednací lhůty bývají dlouhé, termín má smysl domluvit dřív než rozhodnutí',
      ],
      task: 'Pošlete na kliniku žádost o kopii dokumentace ze všech dosavadních cyklů.',
      tip: 'Dokumentaci si ukládejte i v telefonu nebo v počítači. Ať ji máte po ruce, když ji budete potřebovat rychle.',
    },
    {
      id: 'opak-dc2-5',
      phases: ['repeated_failure'],
      dayRange: [10, 51],
      headline: 'Vlastní přehled cyklů na jednom místě',
      body: 'Každá klinika vede dokumentaci po svém a při změně pracoviště se v ní špatně hledá. Jednoduchá vlastní tabulka vám ušetří vzpomínání pod tlakem. Nedělejte z ní hodnocení, je to jen záznam.',
      whatsHappening: [
        'Datum cyklu, typ protokolu a jaké léky jste měla',
        'Počet získaných a oplozených vajíček, počet a den přenesených embryí',
        'Zda šlo o čerstvý nebo kryo přenos a jakou podporu jste užívala',
        'Co jste sama pozorovala, včetně toho, že jste nepozorovala nic',
      ],
      task: 'Založte si jeden sešit nebo soubor a zapište do něj poslední cyklus. Zbytek doplníte postupně.',
      reflection: 'Co si z předchozích cyklů pamatuju přesně a co už si jen domýšlím?',
      tip: 'Výklad čísel nechte na lékaři. Vy sbíráte podklady, ne závěry.',
    },
    {
      id: 'opak-dc2-6',
      phases: ['repeated_failure'],
      dayRange: [18, 55],
      headline: 'Peníze jsou skutečná hranice, ne selhání',
      body: 'Léčba stojí peníze a ty někdy dojdou dřív než odhodlání. Konec kvůli rozpočtu není prohra ani důkaz, že vám na tom záleželo míň. Je to počítání, které dělá každý dospělý člověk.',
      whatsHappening: [
        'Počet hrazených cyklů je omezený a doplatky za léky a metody se sčítají',
        'Náklady se mezi vámi dvěma často dělí nerovnoměrně a to samo dělá napětí',
        'Půjčka na další cyklus zůstane bez ohledu na výsledek',
        'Otevřeně spočítané číslo bolí míň než mlhavý odhad',
      ],
      task: 'Sečtěte, kolik stál poslední cyklus včetně léků, dopravy a volna. Číslo si zapište.',
      reflection: 'Jakou částku uneseme, aniž bychom si tím ublížili?',
    },
    {
      id: 'opak-dc2-7',
      phases: ['repeated_failure'],
      dayRange: [23, 67],
      headline: 'Vztah, který nese opakování',
      body: 'Po několika neúspěších se z léčby snadno stane jediné téma v domácnosti. Partner může mlčet ne proto, že mu to je jedno, ale protože neví, co říct, aby neublížil. Domluvit si dobu, kdy se o léčbě nemluví, není útěk, je to údržba.',
      whatsHappening: [
        'Každý truchlí jinak rychle a jinak nahlas',
        'Sex se může změnit v úkol s termínem a přestat být blízkostí',
        'Jeden z vás obvykle drží organizaci a vyčerpá se dřív',
        'Partner může řešit další krok ve chvíli, kdy vy potřebujete nejdřív truchlit',
      ],
      task: 'Domluvte se na jednom večeru v týdnu, kdy se téma léčby neotevírá. Víc plánovat nemusíte.',
      reflection: 'Co bych partnerovi řekla, kdybych věděla, že to unese?',
    },
    {
      id: 'opak-dc2-8',
      phases: ['repeated_failure'],
      dayRange: [30, 85],
      headline: 'Pauza, která má začátek a konec',
      body: 'Pauza bez konce se snadno protáhne a čas plyne jinak, když se nic neplánuje. Pomáhá dát si orientační datum, kdy se k rozhodování vrátíte. Není to závazek pokračovat: jedním z možných rozhodnutí je i to, že do dalšího cyklu nepůjdete.',
      whatsHappening: [
        'Tělo po opakovaných stimulacích potřebuje čas, který se vůlí nezkrátí',
        'Bez konkrétního data konce se z pauzy stává odkládání',
        'Návrat k věcem, které jste kvůli léčbě odložila, bývá ta těžší část',
        'U části žen se dřív vrátí spánek a chuť k jídlu než klid v hlavě',
      ],
      task: 'Zapište si do kalendáře jedno orientační datum, kdy se k rozhodování vrátíte. Klidně za dva měsíce a klidně ho pak posuňte.',
      tip: 'Datum je vaše pomůcka, ne termín od někoho jiného. Můžete ho kdykoliv změnit nebo škrtnout.',
    },
    {
      id: 'opak-dc2-9',
      phases: ['repeated_failure'],
      dayRange: [34, 111],
      headline: 'Myslet na konec léčby je legitimní',
      body: 'Uvažovat o tom, že jednou přestanete, není vzdání se ani zrada sebe sama. Je to jedna z možností, kterou má právo zvážit každá žena v léčbě. Přemýšlet o ní nahlas neznamená, že jste se už rozhodla.',
      whatsHappening: [
        'Myšlenka na konec se vrací nejčastěji v prvních dnech po negativním výsledku',
        'Okolí ji slyší jako rezignaci, i když jde jen o zvažování',
        'Jeden z páru bývá v uvažování dál a to se dá vydržet, ne vyřešit za večer',
        'Rozhodnutí patří vám, nikomu jinému',
      ],
      reflection: 'Co bych si přála, aby platilo za rok, ať se rozhodnu jakkoli?',
      tip: 'Na tohle téma existují psychologové se zkušeností s neplodností. Jedna konzultace k ničemu nezavazuje.',
      callDoctorIf: [
        'Smutek trvá většinu dne několik týdnů a nepolevuje',
        'Nezvládáte běžné povinnosti, práci ani péči o sebe',
        'Nespíte, nebo naopak nemůžete vstát z postele',
        'Máte myšlenky, že nechcete žít, nebo že byste si ublížila',
        'Alkohol nebo léky na uklidnění užíváte častěji než dřív',
      ],
    },
    {
      id: 'opak-dc2-10',
      phases: ['repeated_failure'],
      dayRange: [26, 155],
      headline: 'Jak dlouho ještě, vaše vlastní odpověď',
      body: 'Na otázku „jak dlouho ještě“ neexistuje obecná odpověď a nikdo ji nemá vyslovovat za vás. Pomáhá dopředu pojmenovat, podle čeho to poznáte vy: podle počtu cyklů, podle peněz, podle věku, podle toho, co ještě unese vaše zdraví a váš vztah. Kritérium si můžete kdykoli změnit, není na tom nic nepoctivého.',
      whatsHappening: [
        'Rozhodnutí v den negativního výsledku bývá jiné než o tři týdny později',
        'Bez pojmenované hranice se dalším krokem automaticky stane další cyklus',
        'Lékař řekne, co je medicínsky ještě na stole, o smyslu rozhodujete vy',
        'Změnit dřívější rozhodnutí není nedůslednost',
      ],
      task: 'Napište si jednu větu, která začíná „Poznám, že mám dost, až“. Nikomu ji nemusíte ukazovat.',
      reflection: 'Podle čeho poznám, že další krok dělám pro sebe, a ne ze setrvačnosti?',
    },
    {
      id: 'mezi-dc2-13',
      phases: ['waiting_next_attempt'],
      dayRange: [0, 30],
      headline: 'Nic neplánovat je taky plán',
      body: 'V pauze se snadno objeví tlak něco využít: zhubnout, doplnit vyšetření, zlepšit se. Nemusíte. Období mezi pokusy má svoji vlastní hodnotu i tehdy, když v něm nic nezlepšíte. Odpočinek není promarněný čas, i když se tak z venku může tvářit.',
      whatsHappening: [
        'Tělo se po hormonální léčbě vrací ke svému rytmu a chvíli mu to trvá',
        'Menstruace po cyklu bývá silnější nebo naopak slabší než jindy',
        'Únava po několika týdnech napětí přichází často až teď, se zpožděním',
        'Okolí se často ptá na další krok dřív, než jste ho sama vymyslela',
      ],
      reflection: 'Co bych dělala tenhle týden, kdyby léčba vůbec neexistovala?',
      tip: 'Když se vás někdo zeptá na další krok, stačí odpovědět, že to teď neřešíte. Nemusíte mít připravený plán.',
    },
    {
      id: 'mezi-dc2-14',
      phases: ['waiting_next_attempt'],
      dayRange: [0, 45],
      headline: 'Otázky se zapisují, ne pamatují',
      body: 'V pauze se vynoří otázky, které v ordinaci nikdy nezazněly, a do další konzultace se spolehlivě rozplynou. Zapisujte si je ve chvíli, kdy vás napadnou, klidně jednou větou. Není to úkol, je to úspora nervů na příště.',
      whatsHappening: [
        'Nejlepší otázky přicházejí večer a ráno o nich nevíte',
        'Konzultace bývá krátká a čas na ní se počítá',
        'Lékař odpovídá na to, na co se zeptáte, ne na to, co vás trápí potichu',
      ],
      task: 'Otevřete v aplikaci BlooMia Otázky pro lékaře a zapište jednu jedinou otázku. Ta první bývá nejtěžší.',
      reflection: 'Na co bych se zeptala, kdybych věděla, že se nikdo nebude divit?',
    },
    {
      id: 'opak-dc2-11',
      phases: ['repeated_failure'],
      dayRange: [0, 30],
      headline: 'Neúspěch není zpráva o vaší snaze',
      body: 'Po několika pokusech se snadno vloudí myšlenka, že se to nedaří kvůli něčemu, co děláte špatně. Většina toho, na čem výsledek stojí, se odehrává mimo dosah čehokoliv, co jde ovlivnit vůlí. Odhodlání, disciplína ani klid embryo neuhnízdí.',
      whatsHappening: [
        'Kvalita vajíček a embryí se nedá ovlivnit snahou ani životosprávou ze dne na den',
        'Uhnízdění probíhá bez jakéhokoliv vědomého vlivu',
        'Většina neúspěšných transferů nemá dohledatelnou konkrétní příčinu',
        'To, že příčina není známá, neznamená, že žádná není',
      ],
      reflection: 'Co si vyčítám, i když to nikdy nebylo v mých rukou?',
      tip: 'Když vám někdo poradí, ať se hlavně uvolníte, není to rada. Nemusíte na ni reagovat ani ji vyvracet.',
    },
    {
      id: 'opak-dc2-12',
      phases: ['repeated_failure'],
      dayRange: [0, 45],
      headline: 'Jeden den bez léčby v kalendáři',
      body: 'Když se pokusy opakují, léčba se roztáhne do všech dnů v týdnu. Pomáhá vyhradit si jeden den, ve kterém se o ní nemluví, nehledá a neplánuje. Není to útěk, je to způsob, jak si udržet kus života, který zůstane váš.',
      whatsHappening: [
        'Vyhledávání informací o léčbě večer prokazatelně zhoršuje spánek',
        'Diskusní fóra ukazují extrémy, ne obvyklý průběh',
        'Mozek potřebuje pauzu od tématu, aby se k němu mohl vrátit s energií',
      ],
      task: 'Vyberte v kalendáři jeden den v příštím týdnu a napište k němu jedno slovo: volno. Nic dalšího plánovat nemusíte.',
      reflection: 'Kdy jsem naposledy strávila celý den, ve kterém léčba nebyla?',
    },
  ],
  encouragements: [
    {
