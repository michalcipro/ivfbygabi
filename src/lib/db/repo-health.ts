...
import { DOC_CATEGORIES, EVENT_KINDS, METRICS } from '../shared/records'

// Tvary a popisky žijí v ../shared/records, aby je mohl importovat i prohlížeč.
export type { CalendarEvent, DocumentRecord, LabValue, Measurement, Medication, MetricKey }
export { DOC_CATEGORIES, EVENT_KINDS, METRICS }
