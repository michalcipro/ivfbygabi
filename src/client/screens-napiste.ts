 ...
 * Napište mi.
 *
 * Jediná obrazovka v aplikaci BlooMia, ze které něco odchází ven. Proto je na ní
...
export function screenNapisteMi(f: Feedback, stav: string): string {
  return [
    `<header class="head rise">
      ...
      <p class="lede">Chybí vám v aplikaci BlooMia něco? Něco nefunguje? Nebo vás naopak něco potěšilo?
    ...
    stav === 'odeslano'
      ? `<section class="surface pad rise" style="border-color:var(--sage-deep)">
          ...
          <p class="soft" style="margin-top:.7rem;line-height:1.7;font-size:.9375rem">
            Vaše zpětná vazba mi pomáhá aplikaci BlooMia dál zlepšovat.
          </p>
        </section>`
      : '',
